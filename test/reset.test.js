...
suite('Reset password', function () {
    ...
    test('should provide reset password after filling form (success case)', function () {
    ...
    test('should provide reset password after filling form (error case)', function () {
